# pending-restore-datastore-write-rollback Specification

## Purpose
TBD - created by archiving change rollback-datastore-on-restore-write-failure. Update Purpose after archive.
## Requirements

# pending-restore-migration-attempt-recovery Specification

## Purpose
TBD - created by archiving change recover-repeated-migration-failure. Update Purpose after archive.
## Requirements

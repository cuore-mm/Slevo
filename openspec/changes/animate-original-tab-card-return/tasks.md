...
- [x] 5.1 板タブとスレッドタブで、長押し開始時に選択カードが前面で拡大表示されることを確認する
- [x] 5.2 板タブとスレッドタブで、選択解除時に元カードが拡大状態から通常サイズへ戻ることを確認する
- [x] 5.3 長押し中の dim overlay、下部操作群、アクションメニュー表示が既存挙動を維持することを確認する
- [x] 5.4 Android CI workflow で build と unit test を確認する

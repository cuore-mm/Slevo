 ...
 *
 * [BackupDataMapper] の export 方向に対する restore 方向の変換を提供する。
 * enum は小文字 kebab-case 文字列から既存 enum へ戻す。
 *
 * 起動時 pending restore の DataStore 反映では、
 * [PendingRestoreDataStoreWriter] がこの mapper 経由で値を変換して DataStore へ保存する。
...
object BackupRestoreMapper {
     ...
     *
     * [BackupDataMapper.enumNameToKebabCase] の逆変換ではないが、

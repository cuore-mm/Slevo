...
private val POST_TEXT_SCALE_KEY = floatPreferencesKey("post_text_scale")
...
class SettingsLocalDataSourceImpl @Inject constructor(
    ...
    override fun observePostTextScale(): Flow<Float> =
        context.dataStore.data
            .map { prefs -> prefs[POST_TEXT_SCALE_KEY] ?: 1f }

    override suspend fun setPostTextScale(scale: Float) {
        context.dataStore.edit { prefs ->
            prefs[POST_TEXT_SCALE_KEY] = scale
        }
    }
}

...
/**
 * Board タブの SessionState 上にある PostDialogState を読み書きするアダプタ。
 *
 * 共通 PostDialogController の更新結果を、対象タブの [BoardSessionState.postDialogState] へ反映する。
 */
internal class BoardPostDialogStateAdapter(
